...
def main():
    ...
    termos_chave = [
        ...
        {"nome": "placa_modelo", "pesquisar": "PLACA"},
        {"nome": "marca_modelo", "pesquisar": "MARCA"},
        {"nome": "especie", "pesquisar": "ESPÉCIE"},
        {"nome": "infração", "pesquisar": "INFRAÇÃO"},
        {"nome": "local", "pesquisar": "LOCAL"},
        {"nome": "numero", "pesquisar": "NUMERO"},
        {"nome": "data_infração", "pesquisar": "DATA DA INFRAÇÃO"},
        {"nome": "hora", "pesquisar": "HORA"},
        {"nome": "data_emissão", "pesquisar": "DATA DA EMISSÃO"},
        {"nome": "velocidade_regulamentada", "pesquisar": "VELOCIDADE REGULAMENTADA"},
        {"nome": "velocidade_medida", "pesquisar": "VELOCIDADE MEDIDA"},
        ...
        {"nome": "pontuação", "pesquisar": "PONTUAÇÃO"},
        {"nome": "número_ait", "pesquisar": "Nº AIT"},
        {"nome": "data_limite_ind_condutor", "pesquisar": "DATA LIMITE IND. CONDUTOR / DEFESA AUTUAÇÃO"},
        {"nome": "nro_infraest", "pesquisar": "NRO. INFRAEST"},
        {"nome": "identificação_equipamento", "pesquisar": "IDENTIFICAÇÃO DO EQUIPAMENTO"},
        {"nome": "aferição_certificação", "pesquisar": "AFERIÇÃO / CERTIFICAÇÃO"},
        {"nome": "agente_trânsito", "pesquisar": "AGENTE DE TRÂNSITO"}
    ]
